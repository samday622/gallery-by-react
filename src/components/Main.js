...
var AppComponent = React.createClass({
  ...
  /*
   * 翻转图片
   * @parm index 输入当前被执行inverse操作的图片对应的图片信息数组的index值
  ...
  /*
  * 利用 rearrange函數，居中对应index的图片
  * @param index，需要被居中的图片独赢图片信息数组的index值
  * @return {function}
  */
   ...
   return{
     imgsArrangeArr:[
       /*{
         ...
         rotate,  //旋转角度
         isInverse:false,  //图片正反面 false为正面
